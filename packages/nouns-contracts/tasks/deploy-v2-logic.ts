...
task('deploy-v2-logic', 'Deploys AlpsDAOLogicV2').setAction(async (_args, { ethers, run }) => {
  const factory = await ethers.getContractFactory('AlpsDAOLogicV2');
  ...
  console.log(`AlpsDAOLogicV2 deployed to ${contract.address}`);
