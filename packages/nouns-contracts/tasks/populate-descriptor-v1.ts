...
task('populate-descriptor-v1', 'Populates the descriptor with color palettes and Alp parts')
  .addOptionalParam(
    'nftDescriptor',
  ...
  .addOptionalParam(
    'alpsDescriptor',
    'The `AlpsDescriptor` contract address',
    '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512',
    types.string,
  )
  .setAction(async ({ nftDescriptor, alpsDescriptor }, { ethers }) => {
    const descriptorFactory = await ethers.getContractFactory('AlpsDescriptor', {
      libraries: {
