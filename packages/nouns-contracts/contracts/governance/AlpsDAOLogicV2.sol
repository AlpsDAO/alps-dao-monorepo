...
/// @title The Alps DAO logic version 2
...
// LICENSE
// AlpsDAOLogicV2.sol is a modified version of Compound Lab's GovernorBravoDelegate.sol:
...
//
// MODIFICATIONS
// See AlpsDAOLogicV1 for initial GovernorBravoDelegate modifications.
...
// max quorum votes using the current Alp supply.
...
contract AlpsDAOLogicV2 is AlpsDAOStorageV2, AlpsDAOEventsV2 {
     ...
     * @param alps_ The address of the NOUN tokens
    ...
    function initialize(
        ...
        require(
            ...
            'AlpsDAO::initialize: invalid proposal threshold bps'
        );
    ...
    function castVoteInternal(
        ...
        uint96 votes = alps.getPriorVotes(voter, proposalCreationBlock(proposal));
    ...
    function _setProposalThresholdBPS(uint256 newProposalThresholdBPS) external {
        ...
        require(
            ...
            'AlpsDAO::_setProposalThreshold: invalid proposal threshold bps'
        );
    ...
    function _setMinQuorumVotesBPS(uint16 newMinQuorumVotesBPS) external {
        ...
        require(
            ...
            'AlpsDAO::_setMinQuorumVotesBPS: invalid min quorum votes bps'
        );
        require(
            newMinQuorumVotesBPS <= params.maxQuorumVotesBPS,
            'AlpsDAO::_setMinQuorumVotesBPS: min quorum votes bps greater than max'
        );
    ...
    function _setMaxQuorumVotesBPS(uint16 newMaxQuorumVotesBPS) external {
        ...
        require(
            ...
            'AlpsDAO::_setMaxQuorumVotesBPS: invalid max quorum votes bps'
        );
        require(
            params.minQuorumVotesBPS <= newMaxQuorumVotesBPS,
            'AlpsDAO::_setMaxQuorumVotesBPS: min quorum votes bps greater than max'
        );
     ...
     * @param totalSupply The total supply of Alps at the time of proposal creation
    ...
    function getDynamicQuorumParamsAt(uint256 blockNumber_) public view returns (DynamicQuorumParams memory) {
        uint32 blockNumber = safe32(blockNumber_, 'AlpsDAO::getDynamicQuorumParamsAt: block number exceeds 32 bits');
    ...
    /**
     * @notice Current min quorum votes using Alp total supply
     */
    function minQuorumVotes() public view returns (uint256) {
        return bps2Uint(getDynamicQuorumParamsAt(block.number).minQuorumVotesBPS, alps.totalSupply());
    }

    /**
     * @notice Current max quorum votes using Alp total supply
     */
    function maxQuorumVotes() public view returns (uint256) {
        return bps2Uint(getDynamicQuorumParamsAt(block.number).maxQuorumVotesBPS, alps.totalSupply());
    }
