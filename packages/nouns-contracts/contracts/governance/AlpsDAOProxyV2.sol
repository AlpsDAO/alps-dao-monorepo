...
/// @title The Alps DAO proxy contract for V2
...
// AlpsDAOProxyV2.sol is a modified version of AlpsDAOProxy.sol, tailored for the DAO's V2.
...
contract AlpsDAOProxyV2 is AlpsDAOStorageV2, AlpsDAOEvents {
    constructor(
        address timelock_,
        address Alps_,
        address vetoer_,
