...
import { AlpsToken, AlpsDescriptorV2__factory as AlpsDescriptorV2Factory } from '../../typechain';
...
describe('Alps Governance', () => {
  let snapshotId: number;
  let token: AlpsToken;
  let tokenCallFromGuy: AlpsToken;
  let tokenCallFromDeployer: AlpsToken;
  ...
  before(async () => {
    ...
    domain = Domain('Alps', token.address, await chainId());
